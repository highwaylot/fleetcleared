...
(() => {
  ...
  const existing = [
    { name: 'Buckeye Fleet Advisors', phone: '(614) 555-0100', address: '100 North High Street, Columbus OH', email: 'ops@buckeyefleet.com', ip: '10.0.0.5', signedUpAt: '2026-09-01', cardFingerprint: 'card_A', freeLeadUsed: true },
    { name: 'Red Mesa Compliance', phone: '210-555-0199', address: '9 Alamo Rd, San Antonio TX', email: 'hi@redmesacompliance.com', ip: '10.0.0.9', signedUpAt: '2026-06-01', cardFingerprint: 'card_B', freeLeadUsed: false },
    { name: 'Delta Pine Safety Co.', phone: '478-555-0123', address: '44 Cherry St, Macon GA', email: 'plans@deltapinesafety.com', ip: '10.0.1.2', signedUpAt: '2026-05-10', cardFingerprint: null, freeLeadUsed: true },
  ];

  const applicants = [
    { name: 'Lakeshore DOT Partners', email: 'info@lakeshoredot.com', website: 'https://www.lakeshoredot.com', phone: '800-555-0111', address: '12 Commerce Dr, Dallas TX', submitted: 'Sep 20', inStateRegistry: true, phoneLineType: 'landline', webPresenceFound: true, emailDomainAgeDays: 3000, ip: '10.2.2.2', signedUpAt: '2026-09-20' },
    { name: 'Buckeye Safety Services', email: 'hello@gmail.com', phone: '614.555.0100', address: '7 Oak Ave, Columbus OH', submitted: 'Sep 21', inStateRegistry: true, phoneLineType: 'mobile', webPresenceFound: true, ip: '10.0.0.5', signedUpAt: '2026-09-21', appeal: { sent: 'Sep 22', text: 'We share an office suite and phone line with Buckeye Fleet Advisors, but we are a separate LLC. Our Ohio filing is linked below.', link: 'https://example.com/ohio-filing' } },
    { name: 'Summit Lane Safety LLC', email: 'contact@summitlanesafety.com', website: 'https://summitlanesafety.com', phone: '888-555-0177', address: '3 River Rd, Nashville TN', submitted: 'Sep 22', inStateRegistry: true, phoneLineType: 'landline', webPresenceFound: true, emailDomainAgeDays: 2400, associationMember: true, ip: '10.3.3.3', signedUpAt: '2026-09-22' },
  ...
  const leads = [
    { date: 'Sep 21', consultant: 'Buckeye Fleet Advisors', carrier: 'L. Brooks · (740) 555-0133', trucks: 12, account: { freeLeadUsedByBusiness: true, cardOnFile: true, leadsThisMonth: 3, monthlyCap: 10 } },
    { date: 'Sep 19', consultant: 'Delta Pine Safety Co.', carrier: 'M. Ortiz · (229) 555-0170', trucks: 4, account: { freeLeadUsedByBusiness: true, cardOnFile: false, leadsThisMonth: 1, monthlyCap: 5 } },
    { date: 'Sep 18', consultant: 'Delta Pine Safety Co.', carrier: 'D. Alvarez · (912) 555-0142', trucks: 2, account: { freeLeadUsedByBusiness: false, cardOnFile: false, leadsThisMonth: 0, monthlyCap: 5 } },
    { date: 'Sep 10', consultant: 'Buckeye Fleet Advisors', carrier: 'T. Nguyen · tnguyen@qtrucking.com', trucks: 1, account: { freeLeadUsedByBusiness: false, cardOnFile: false, leadsThisMonth: 0, monthlyCap: 10 } },
    { date: 'Sep 5', consultant: 'Buckeye Fleet Advisors', carrier: 'R. Patel · (614) 555-0188', trucks: 6, account: { freeLeadUsedByBusiness: true, cardOnFile: true, leadsThisMonth: 1, monthlyCap: 10 } },
  ];
